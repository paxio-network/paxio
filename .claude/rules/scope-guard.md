...
```bash
git -C /home/nous/paxio worktree add /home/nous/paxio-worktrees/<session> -b feature/M-XX-name origin/dev
cd /home/nous/paxio-worktrees/<session>
pnpm install                              # owns its own node_modules/
git config user.email <agent>@paxio.network
```

После merge: `git worktree remove --force /home/nous/paxio-worktrees/<session>` или
