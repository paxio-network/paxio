...
| **frontend-dev** | `apps/frontend/` (8 apps: landing, registry, pay, radar, intel, docs, wallet, fleet), `packages/{ui,hooks,api-client,auth}/` | `apps/back/`, `products/`, `canisters/`, `packages/{types,interfaces,errors,contracts,utils}/` (только читает для API типов) |
